...
func BuildSystemPrompt(identity, userContext, gitContext string, toolNames []string, assistantName, assistantIcon string, allowSystemAccess bool) string {
	...
	b.WriteString("- When the user declines or says they don't need something (e.g. \"no\", \"that's all\", \"won't be required\"),\n")
	b.WriteString("  acknowledge briefly and stop. Do not add an unprompted greeting or \"How can I help you today?\" in the same turn.\n\n")
